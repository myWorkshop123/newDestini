...
struct StoryBrain {
    ...
    func updateQuestion() -> [Int]{
        
        // Get the story choices Destination for that story number
        return [story[storyNumber].choice1Destination , story[storyNumber].choice2Destination ]
        
        
    }
    
    mutating func setStoryNumber(number:Int){
        storyNumber = number
    }
